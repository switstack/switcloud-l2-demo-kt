...
class EmvUtils {
    companion object {
        ...
        fun getOPSVerdict(hexValueString: String): OPSVerdictEnum {
            ...
            if (OPSValueByteArray.size >= 4 && OPSValueByteArray[3] == 0x20.toByte()) {
                ...
                if (OPSValueByteArray.isNotEmpty() &&
                    ...
                    return OPSVerdictEnum.APPROVED
                } else {
                    return OPSVerdictEnum.DECLINED
                }
            }
        }
        ...
        fun getOPSVerdictLabel(success: Boolean): String = if (success) { OPSVerdictEnum.APPROVED.name } else { OPSVerdictEnum.DECLINED.name }
    }
}
